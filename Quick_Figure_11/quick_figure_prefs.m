...
quick_figure_dir = 'E:\';                                               %Define the directory to save the results to
ppt_word_filename = 'DATA\ImagingData\Awake\Behavior_Imaging\NXJF36703\090717\PPT_files';                              %Define the filename to save PPT or DOC results to, new slides and images are appended if this file already exists
