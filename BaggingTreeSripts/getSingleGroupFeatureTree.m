function results = getSingleGroupFeatureTree(x,y,type,N_bagging,N_time,minLeaf,names,groups,whichGroups)
...
results = bagTreeRegression (x_train,y_train,type2, N_bagging,N_time,minLeaf,0);